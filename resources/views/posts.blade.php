...
<div class="card mb-3">
    @if ($posts[0]->image)
    <div style="max-height: 400px; overflow: hidden; aligin-item:center">
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                <div class="position-absolute p-3 py-2 text-white" style="border-bottom-right-radius: 0.25rem;
                    border-top-left-radius: 0.25rem; background-color:rgba(0, 0, 0, 0.7 )">
